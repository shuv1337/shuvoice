"""Entry: python -m nemo_asr [--fake] [-v]"""
...
# Allow `python -m nemo_asr` from the workers/ directory without install.
...
from .worker import NemoAsrHandler  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    def factory() -> NemoAsrHandler:
        return NemoAsrHandler(fake=fake)
